...
folder_name_train = 'data/Glass/train_data.mat'
folder_name_val = 'data/Glass/val_data.mat'
folder_name_test = 'data/Glass/test_data.mat'
...
folder_name_params = 'params/Glass'
...
if dogolden_search == 0:    
    ...
    with open("bug_log_BNN_multiclass.txt", "w") as log:
        ...
        try:
            crit = lambda reg: run_PMCnet_fixedReg_multiclass(simulations,reg,loss,N_resampled,results_dir, x_test, y_test1,is_binary,N,K,T,sig_prop,lr,gr_period,tp,est_ml,epsilon1,epsilon2,logger)
