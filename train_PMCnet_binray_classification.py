...
if dogolden_search == 0:    
    ...
    with open("bug_log_BNN_binaryclass.txt", "w") as log:
        ...
        try:
            crit = lambda reg: run_PMCnet_fixedReg(simulations,reg,loss,N_resampled,results_dir, x_val, y_val1,is_binary,N,K,T,sig_prop,lr,gr_period,tp,est_ml,epsilon1,epsilon2,logger)
